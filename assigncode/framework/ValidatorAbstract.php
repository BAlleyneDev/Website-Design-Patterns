 ...
 * implementations.
 */ 
abstract class ValidatorAbstract implements ValidatorAbstractInterface {
	/**
	...
	protected function _checkEntry($variablename, $variable, $label) {
		if ((trim($variable) =='') || ($variable == '--') || ($variable == '-- Select One --')) {
			$this->_errors[] = (empty($this->_pageVarDataData[$variablename]['errormessage'])) ? "$label: Select or enter a value. Field cannot be all spaces or empty." : $this->_pageVarData[$variablename]['errormessage'];
		}
...
interface ValidatorAbstractInterface{
