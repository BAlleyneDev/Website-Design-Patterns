		...
		<ul class="course-list">
			...
			foreach ($course as $key => $record)
			   ...
			   echo '
				...
				<div>
					<a href="index.php?controller=Profile" class="startnow-btn startnow-button">Cancel</a>
					<a href="index.php?controller=UnenrollConfirmed&id='.$record['course_id'].'" class="startnow-btn unenroll-button">Okay</a>
				</div>
			</li>
				   ';} ?>
